...
- `feature/<name>` — new functionality (e.g. `feature/trace-ingestion`)
...
1. Pick up an open issue (see the [issue tracker](https://github.com/saikumardeepak1/helios/issues) and [roadmap](docs/ROADMAP.md)).
